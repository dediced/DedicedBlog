...
# NOTE: Make sure to include the command: "python manage.py collectstatic --noinput" in the Procfile.
...
# Additional locations of static files (other than the apps' "static/" subdirectories.
STATICFILES_DIRS = (
...
SECRET_KEY = '4ndscv-b4^jxk4@_(#sw1gk(@!c9@fx@95+=g5hgii-ud+3r!r'
